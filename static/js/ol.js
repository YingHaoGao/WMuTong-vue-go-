...
;(function (root, factory) {
    ...
    switch (e) {
      ...
      case "MultiPolygon":
        ...
        for (e = b.length; a < e; ++a) {
          var g = b[a];
          var h = 0;
          for (f = g.length; h < f; ++h)c += sb(g[h], d)
        }
        break;
  ...
  function sb(a, b) {
    for (var c = 0, d = 0, e = a.length; d < e - 1; ++d)c += qb(a[d], a[d + 1], b);
    return c
  }
  ...
  w(xb, wb);
  var Ab = 6378137 * Math.PI, yb = [-Ab, -Ab, Ab, Ab],
    zb = [-180, -85, 180, 85],
  ...
  function Ob(a) {
    var b = null;
    if (a instanceof wb) b = a; else if ("string" === typeof a && (b = Ib[a] || null, !b)) {
  ...
  k.Vf = function (a, b, c) {
    a = tc(this, a, b);
    for (var d = a.fa, e = a.la; d <= e; ++d)for (var f = a.ea, g = a.ka; f <= g; ++f)c([b, d, f])
  };
  ...
  k.Ma = function (a, b) {
    var c = this.Ic(a[0]), d = this.Ta(a[0]), e = Ba(this.Za(a[0]), this.f),
      f = c[0] + a[1] * e[0] * d;
    a = c[1] + a[2] * e[1] * d;
  ...
  Sc.prototype.b = function (a) {
    ...
    if (c) {
      ...
      ++this.qa[a];
      for (var d = 0, e = c.length; d < e; ++d)if (!1 === c[d].call(this, b) || b.sj) {
        var f = !1;
        break
      }
      --this.qa[a];
  ...
  function B(a, b) {
    ...
    this.c = !!(b || {}).unique;
    this.a = a ? a : [];
    if (this.c)for (a = 0, b = this.a.length; a < b; ++a)$c(this, this.a[a], a);
    ad(this)
  }
  ...
  k.remove = function (a) {
    var b = this.a, c;
    var d = 0;
    for (c = b.length; d < c; ++d)if (b[d] === a)return this.Wg(d)
  };
  k.Wg = function (a) {
    var b = this.a[a];
    this.a.splice(a, 1);
  ...
  var hd,
    id = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "",
    jd = -1 !== id.indexOf("firefox"),
    kd = -1 !== id.indexOf("safari") && -1 == id.indexOf("chrom"),
    ld = -1 !== id.indexOf("webkit") && -1 == id.indexOf("edge"),
    md = -1 !== id.indexOf("macintosh"), nd = window.devicePixelRatio || 1,
    od = !1, pd = function () {
      ...
      window, rd = "geolocation" in navigator, sd = "ontouchstart" in window,
    td = "PointerEvent" in window, ud = !!navigator.msPointerEnabled, vd = !1,
    wd, xd = [];
  ...
  function Fd(a, b) {
    for (var c = {}, d, e = 0, f = ae.length; e < f; e++)d = ae[e][0], c[d] = a[d] || b[d] || ae[e][1];
    return c
  }
  ...
  function Ce(a, b, c) {
    ...
    c = c || 0;
    var e = Math.pow(10, c), f = Math.floor(d / 3600),
  ...
  function Ze(a, b) {
    var c = a[0], d = a[1], e = a[2], f = a[3], g = a[4], h = a[5], l = b[0],
  ...
  function tf(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    for (var q = n ? n : [NaN, NaN], r = b + d; r < c;)if (of(a, r - d, r, d, g, h, q), p = ua(g, h, q[0], q[1]), p < m) {
      m = p;
  ...
  function Bf(a, b, c, d, e, f, g) {
    ...
    for (var m = 0, n; 0 < c.length;) {
      var p = c.pop(), q = c.pop(), r = 0, u = a[q], v = a[q + 1], z = a[p],
        A = a[p + 1];
      for (n = q + d; n < p; n += d) {
  ...
  k.Uf = function (a, b) {
    ...
    var c = b.size;
    c || (c = eg(this));
    if (a instanceof hf)if ("Circle" === a.S()) {
      a = a.G();
      var d = Rf(a);
      d.rotate(this.Sa(), eb(a))
    } else d = a; else oa(Array.isArray(a), 24), oa(!bb(a), 25), d = Rf(a);
  ...
  k.Tc = function (a, b, c) {
    if (this.c)return a = this.Ra(a), c = void 0 !== c ? c : {}, this.pc.wa(a, this.c, void 0 !== c.hitTolerance ? c.hitTolerance * this.c.pixelRatio : 0, b, null, void 0 !== c.layerFilter ? c.layerFilter : Re, null)
  };
  k.Xf = function (a, b) {
    var c = null;
  ...
  k.tg = function (a, b, c, d, e) {
    if (this.c)return this.pc.Ti(a, this.c, b, void 0 !== c ? c : null, void 0 !== d ? d : Re, void 0 !== e ? e : null)
  };
  k.ng = function (a, b) {
    if (!this.c)return !1;
    a = this.Ra(a);
  ...
  k.pq = function () {
    var a = Date.now(), b, c = this.Cb(), d = this.aa(), e = Da(), f = this.c,
      g = null;
  ...
  function sg(a) {
    ...
    var g =
      f.length;
    a:for (; e < g; ++e)for (var h = f[e], l = 0, m = og.length; l < m; ++l) {
      var n = og[l];
      if (n.handles(h)) {
        var p = n;
        break a
    ...
    if (void 0 !== a.controls)if (Array.isArray(a.controls))var q = new B(a.controls.slice()); else oa(a.controls instanceof B, 47), q = a.controls;
    if (void 0 !== a.interactions)if (Array.isArray(a.interactions))var r = new B(a.interactions.slice()); else oa(a.interactions instanceof B, 48), r = a.interactions;
  ...
  function Ag(a) {
    if (a = a.frameState) {
      for (var b = {}, c = [], d = a.layerStatesArray, e = a.viewState.resolution, f = 0, g = d.length; f < g; ++f) {
        var h = d[f];
        if (yg(h, e) && (h = h.layer.ha()) && (h = h.C) && (h = h(a)))if (Array.isArray(h))for (var l = 0, m = h.length; l < m; ++l)h[l] in b || (c.push(h[l]), b[h[l]] = !0); else h in b || (c.push(h), b[h] = !0)
      }
      if (!jc(c, this.B)) {
        ...
        for (var n in a)if (d = a[n], d instanceof HTMLElement && (this.l.appendChild(d), c[n] = d), !(n in c)) {
          var p = new Image;
          p.src = n;
  ...
  function Zh(a) {
    a = a ? a : {};
    var b = new B, c = new Gg(-.005, .05, 100);
    ...
    if (void 0 !== a.keyboard ?
        a.keyboard : 1) b.push(new Dh), b.push(new Fh({
      delta: a.zoomDelta,
      duration: a.zoomDuration
    }));
  ...
  k.remove = function (a) {
    ...
    oa(void 0 !== b, 15);
    if (b === this.c) {
      if (this.c = b.Pb) this.c.kb = null
    } else if (b === this.g) {
      if (this.g = b.kb) this.g.Pb = null
    } else b.kb.Pb = b.Pb, b.Pb.kb = b.kb;
    delete this.a[a];
    --this.i;
    return b.Pc
  };
  ...
  var ei = [0, 0, 0, 1], fi = [], gi = [0, 0, 0, 1], hi = [0, 0, 0, 0],
  ...
  function Hi(a, b, c, d, e) {
    var f;
    var g = 0;
    for (f = d.length; g < f; ++g)c = Gi(a, b, c, d[g], e, !0);
    return c
  }
  ...
  k.De = function (a) {
    ...
    var b;
    var c = 0;
    for (b = a.length; c < b; ++c)this.Hb(a[c])
  };
  k.yc = function (a) {
    var b = a.da();
    a = a.pa();
  ...
  function Fi(a, b) {
    ...
    d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), od && (jc(d.lineDash, b.lineDash) || c.setLineDash(d.lineDash = b.lineDash), d.lineDashOffset != b.lineDashOffset && (d.lineDashOffset = c.lineDashOffset = b.lineDashOffset)), d.lineJoin != b.lineJoin && (d.lineJoin = c.lineJoin = b.lineJoin), d.lineWidth != b.lineWidth && (d.lineWidth = c.lineWidth = b.lineWidth), d.miterLimit != b.miterLimit && (d.miterLimit = c.miterLimit = b.miterLimit), d.strokeStyle != b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle)) :
      (c.lineCap = b.lineCap, od && (c.setLineDash(b.lineDash), c.lineDashOffset = b.lineDashOffset), c.lineJoin = b.lineJoin, c.lineWidth = b.lineWidth, c.miterLimit = b.miterLimit, c.strokeStyle = b.strokeStyle, a.O = {
        lineCap: b.lineCap,
        lineDash: b.lineDash,
  ...
  w(Xi, Ki);
  function Yi(a, b, c) {
    var d = b.pixelRatio, e = b.size[0] * d, f = b.size[1] * d,
      g = b.viewState.rotation, h = $a(c), l = Za(c), m = Ya(c);
    c = Wa(c);
  ...
  function Zi(a, b, c, d, e) {
    var f = a.a;
    if (Tc(f, b)) {
      var g = d.size[0] * d.pixelRatio, h = d.size[1] * d.pixelRatio,
  ...
  Xi.prototype.s = function (a, b, c, d) {
    if (this.wa(a, b, 0, Re, this))return c.call(d, this.a, null)
  };
  ...
  bj.create = function (a, b) {
    var c = new bj(b);
    if ("VECTOR" === b.S())for (var d = 0, e = pg.length; d < e; ++d) {
      var f = pg[d];
  ...
  bj.prototype.$c = function (a, b) {
    var c = a.pixelRatio, d = a.size, e = a.viewState, f = e.center,
      g = e.resolution, h = this.a.ha(), l = a.viewHints, m = a.extent;
    void 0 !== b.extent && (m = gb(m, b.extent));
    if (!l[0] && !l[1] && !bb(m))if (l = e.projection, e = this.c) {
      l = e.context;
      var n = kb({}, a, {
        size: [cb(m) / g, db(m) / g],
  ...
  w(fj, Oc);
  function gj(a) {
    var b = a.viewState, c = a.coordinateToPixelTransform,
  ...
  function ij(a, b) {
    ...
    if (d) a.c[c] = d, a.v[c] = y(d, "change", a.gm, a); else throw Error("Unable to create renderer for layer: " + b.S());
    return d
  }
  ...
  function lj(a, b, c) {
    var d = a.l, e = a.g;
    if (Tc(d, b)) {
      var f = c.extent, g = c.pixelRatio, h = c.viewState.rotation,
        l = c.viewState, m = c.pixelRatio / l.resolution;
  ...
  kj.prototype.bh = function (a) {
    if (a) {
      var b = this.g, c = a.pixelRatio, d = Math.round(a.size[0] * c),
  ...
  kj.prototype.Ti = function (a, b, c, d, e, f) {
    ...
    for (--l; 0 <= l; --l) {
      var m = h[l];
      var n = m.layer;
      if (yg(m, g) && e.call(f, n) && (m = ij(this, n).s(a, b, c, d)))return m
    }
  };
  function mj(a) {
    aj.call(this, a);
  ...
  mj.prototype.$c = function (a, b) {
    var c = a.pixelRatio, d = a.size, e = a.viewState, f = e.projection,
      g = e.resolution;
    e = e.center;
    var h = this.a, l = h.ha(), m = l.g, n = l.eb(f), p = n.Dc(g, this.O),
      q = n.Ta(p), r = Math.round(g / q) || 1, u = a.extent;
    void 0 !== b.extent && (u = gb(u, b.extent));
    if (bb(u))return !1;
    var v = tc(n, u, p), z = wc(n, p, v), A = l.Xc(c), E = {};
    E[p] = {};
    var S = this.Rf(l, f, E), Ia = this.T, ta = this.ra, la = !1, ca, ia;
    for (ca = v.fa; ca <= v.la; ++ca)for (ia = v.ea; ia <= v.ka; ++ia) {
  ...
  (function (a) {
    function b(a, e, f, g, h) {
      ...
      for (h = h || d; g > f;) {
        if (600 < g - f) {
          var l = g - f + 1, m = e - f + 1, n = Math.log(l),
            p = .5 * Math.exp(2 * n / 3);
    ...
    function g(a, b, c, d, e) {
      ...
      e.la = -Infinity;
      e.ka = -Infinity;
      for (var f; b < c; b++)f = a.children[b], h(e, a.fb ? d(f) : f);
      return e
    }
    ...
    function v(a, b, c, d, e) {
      for (var f = [b, c], g; f.length;)c = f.pop(), b = f.pop(), c - b <= d || (g = b + Math.ceil((c - b) / d / 2) * d, z(a,
        g, b, c, e), f.push(b, g, g, c))
    }
    ...
    e.prototype = {
      all: function () {
        ...
        for (var e = [], f, g, h, l; b;) {
          f = 0;
          for (g = b.children.length; f < g; f++)h = b.children[f], l = b.fb ? d(h) : h, r(a, l) && (b.fb ? c.push(h) : q(a, l) ? this.rh(h, c) : e.push(h));
          b = e.pop()
        }
        return c
      }, Ok: function (a) {
        ...
        for (var d = [], e, f, g, h; b;) {
          e = 0;
          for (f = b.children.length; e < f; e++)if (g = b.children[e], h = b.fb ? c(g) : g, r(a, h)) {
            if (b.fb || q(a,
                h))return !0;
            d.push(g)
          }
        ...
        if (a.length < this.wh) {
          for (var b = 0, c = a.length; b < c; b++)this.Ca(a[b]);
          return this
        }
      ...
      remove: function (a, b) {
        ...
        for (var c = this.data, d = this.xb(a), e = [], f = [], g, h, l, m; c || e.length;) {
          ...
          m || c.fb || !q(c, d) ? h ? (g++, c = h.children[g], m = !1) : c = null : (e.push(c), f.push(g), g = 0, h = c, c = c.children[0])
        }
        return this
      }, xb: function (a) {
        return a
      ...
      rh: function (a, b) {
        for (var c = []; a;)a.fb ? b.push.apply(b, a.children) : c.push.apply(c, a.children), a = c.pop();
        return b
      }, th: function (a, b, c, d) {
        ...
        for (var e, f, g, h, l, m, p, q; ;) {
          ...
          p = q = Infinity;
          e = 0;
          for (f = b.children.length; e < f; e++)g = b.children[e], l = n(g), m = (Math.max(g.la, a.la) - Math.min(g.fa, a.fa)) * (Math.max(g.ka, a.ka) - Math.min(g.ea, a.ea)) - l, m < q ? (q = m, p = l < p ? l : p, h = g) : m === q && l < p && (p = l, h = g);
          b = h || b.children[0]
        }
        return b
      }, vh: function (a, b, c) {
        ...
        e.children.push(a);
        for (h(e, c); 0 <= b;)if (d[b].children.length > this.Lf) this.Dk(d,
          b), b--; else break;
        this.uk(c, d, b)
      }, Dk: function (a, b) {
        ...
        var d = a.fb ? this.Pf : l, e = a.fb ? this.Qf : m,
          f = this.sh(a, b, c, d);
        b = this.sh(a, b, c, e);
        ...
        for (m = c - b - 1; m >= b; m--)n = a.children[m], h(f, a.fb ? d(n) : n), l += p(f);
        return l
      },
      uk: function (a, b, c) {
        for (; 0 <= c; c--)h(b[c], a)
  ...
  function zj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, v, z, A, E) {
    ...
    v = a.La;
    var ta = z[3] + u * r + z[1], la = z[0] + l * r + z[2], ca = c - z[3],
      ia = d - z[0];
    if (S || 0 !== q) {
      var xa = [ca, ia];
      var Va = [ca + ta, ia];
    ...
    if (h) {
      if (q || 1 != h[4]) Ta(h, v), (a = q ? [b, z ? z.slice(0) : null, m, e, n, p, u, l, c, d, r] : null) && S && a.push(A, E, xa, Va, ic, Xa), h.push(a)
    } else q && (S && xj(a, b, xa, Va, ic, Xa, A, E), si(b, z, m, e, n, p, u, l, c, d, r))
  }
  ...
  function Gj(a, b, c) {
    if (b && 5 < b.length) {
      ...
      if (1 == d || d == b.length - 5) {
        ...
        if (!a.ra.Ok(c))for (a.ra.Ca(c), c = 5, d = b.length; c < d; ++c) {
          var e = b[c];
  ...
  function Hj(a, b, c, d, e, f, g) {
    if (a.oa && jc(c, a.ca))var h = a.oa; else a.oa || (a.oa = []), h = Te(a.coordinates, 0, a.coordinates.length, 2, c, a.oa), $e(a.ca, c);
    for (var l = !nb(d), m = 0, n = e.length, p = 0, q, r, u, v, z, A, E, S, Ia, ta = 0, la = 0, ca = null, ia = null, xa = a.Ub, Va = a.$, ic = {
      ...
      switch (Z[0]) {
        ...
        case 2:
          p = Z[1];
          var Le = h[p], Uf = h[p + 1], Id = h[p + 2] - Le, te = h[p + 3] - Uf,
        ...
        case 6:
          ...
          S = f ? null :
            Z[6];
          var rf = Z[7], yu = Z[8], zu = Z[9], Au = Z[10], Bu = Z[11],
            jp = Z[12], Cu = Z[13], Du = Z[14], Eu = Z[15];
          if (16 < Z.length) {
            var kp = Z[16];
            var lp = Z[17];
            var mp = Z[18]
        ...
        case 5:
          ...
          S = f ? null : Z[4];
          var Fu = Z[5], pp = Z[6], Gu = Z[7], qp = Z[8], rp = Z[9], sp = Z[10],
            tp = Z[11], up = Z[12], Mk = Z[13], vp = Z[14],
            wp = tj(h, np, op, 2), xp = qp(up);
          if (Fu || xp <= wp) {
            a:{
              var Ni = void 0, yp = void 0, Xf = void 0,
                sf = h, ve = np, zp = op, Ap = up, Hu = qp,
                Bp = (wp - xp) * vj[a.s[Mk].textAlign], Iu = Gu, Nk = [],
                Kh = sf[ve] > sf[zp - 2], Cp = Ap.length, Lh = sf[ve],
                Mh = sf[ve + 1];
              ve += 2;
            ...
            if (Sg) {
              ...
              if (pp)for (Zf = 0, Ri = Sg.length; Zf < Ri; ++Zf)ee = Sg[Zf], Rk = ee[4], Ne = a.Y(Rk, Mk, pp, ""), r = ee[2], u = Lk * Ne.height - rp, zj(a, b, ee[0], ee[1], Ne, r, u, S, Ne.height, 1, 0, 0, ee[3], vp, !1, Ne.width, hi, null, null)
            }
          }
          Gj(a, S, Zb);
          ++m;
  ...
  function Jj(a, b, c, d) {
    var e = b.fillStyle;
    if ("string" !== typeof e || b.Pk != e) c.call(a, b, d), b.Pk = e
  }
  
  function Kj(a, b, c) {
    var d = b.strokeStyle, e = b.lineCap, f = b.lineDash, g = b.lineDashOffset,
      h = b.lineJoin, l = b.lineWidth, m = b.miterLimit;
  ...
  Mj.prototype.uc = function (a, b) {
    ...
    void 0 !== c.strokeStyle && void 0 !== d && (Kj(this, c, this.pd), Ej(this, b), this.b.push([11, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash, c.lineDashOffset], [1]), c = a.da(), Nj(this, c, 0, c.length, a.pa()), this.b.push([12]), Fj(this, b))
  };
  Mj.prototype.vc = function (a, b) {
    ...
    if (void 0 !== c.strokeStyle && void 0 !== d) {
      ...
      var e = 0, f;
      var g = 0;
      for (f = c.length; g < f; ++g)e = Nj(this, d, e, c[g], a);
      this.b.push([12]);
      Fj(this, b)
    }
  };
  ...
  Oj.prototype.xc = function (a, b) {
    ...
    if (void 0 !== c.fillStyle || void 0 !== d) {
      ...
      var e = 0, f;
      var g = 0;
      for (f = c.length; g < f; ++g)e = Pj(this, d, e, c[g], a);
      Fj(this, b)
    }
  };
  ...
  Rj.prototype.Wb = function (a, b) {
    ...
    if ("" !== this.ta && e && (c || d)) {
      ...
      if ("line" === e.placement) {
        ...
        d = a.da();
        h = a.pa();
        if ("LineString" == f)var l = [d.length]; else if ("MultiLineString" == f) l = a.pb(); else if ("Polygon" == f) l = a.pb().slice(0, 1); else if ("MultiPolygon" == f)for (a = a.td(), l = [], g = 0, f = a.length; g < f; ++g)l.push(a[g][0]);
        Ej(this, b);
        a = e.textAlign;
        var m = 0, n;
        f = 0;
        ...
        Ej(this, b);
        if (e.backgroundFill || e.backgroundStroke) this.Oa(e.backgroundFill, e.backgroundStroke), Jj(this, this.state,
          this.Ah, a), Kj(this, this.state, this.pd);
        Tj(this, l, c, g)
      }
      Fj(this, b)
    }
  ...
  Rj.prototype.Y = function (a, b, c, d) {
    ...
    if (!ii.a.hasOwnProperty(e)) {
      var f = d ? this.ab[d] || this.g : null,
        g = c ? this.o[c] || this.c : null, h = this.s[b] || this.f,
        l = h.scale * this.pixelRatio, m = vj[h.textAlign || "center"];
  ...
  function Tj(a, b, c, d) {
    var e = a.f, f = a.g, g = a.pixelRatio, h = vj[e.textAlign || "center"],
      l = vj[e.textBaseline];
  ...
  function Xj(a) {
    if (void 0 !== Vj[a])return Vj[a];
    for (var b = 2 * a + 1, c = Array(b), d = 0; d < b; d++)c[d] = Array(b);
    b = a;
    for (var e = d = 0; b >= d;)Wj(c, a + b, a + d), Wj(c, a + d, a + b), Wj(c, a - d, a + b), Wj(c, a - b, a + d), Wj(c, a - b, a - d), Wj(c, a - d, a - b), Wj(c, a + d, a - b), Wj(c, a + b, a - d), d++, e += 1 + 2 * d, 0 < 2 * (e - b) + 1 && (--b, e += 1 - 2 * b);
    return Vj[a] = c
  }
  ...
  k.wa = function (a, b, c, d, e, f, g) {
    ...
    var h = 2 * d + 1,
      ...
      m = this.f;
    m.canvas.width !== h || m.canvas.height !== h ? (m.canvas.width = h, m.canvas.height = h) : m.clearRect(0, 0, h, h);
    if (void 0 !== this.i) {
      var n = Da();
      Ea(n, a);
      Fa(n, b * (this.i + d), n)
    ...
    return Zj(this, m, l, c, e, function (a) {
      for (var b = m.getImageData(0, 0, h, h).data, c = 0; c < h; c++)for (var d = 0; d < h; d++)if (p[c][d] && 0 < b[4 * (d * h + c) + 3]) {
        var e;
        q && -1 === q.indexOf(a) ||
        (e = f(a));
        if (e)return e;
  ...
  function Zj(a, b, c, d, e, f, g, h) {
    ...
    for (m = l.length - 1; 0 <= m; --m) {
      ...
      for (n = uj.length - 1; 0 <= n; --n) {
        var r = uj[n];
        var u = q[r];
        if (void 0 !== u)if (!h || "Image" != r && "Text" != r) {
          r = b;
          var v = c, z = e, A = f, E = g;
          u.$ = d;
          if (u = Hj(u, r, v, z, u.b, A, E))return u
        } else(r = h[p]) ? r.push(u, c.slice(0)) : h[p] = [u, c.slice(0)]
      }
    }
  }
  ...
  function ek(a, b, c, d, e, f) {
    ...
    if (e = (0, c.cb)(b))if (d = e.Wd(d), c.Ie()) fk(a, d, c, b); else(0, gk[d.S()])(a, d, c, b);
    return g
  }
  ...
  function fk(a, b, c, d) {
    if ("GeometryCollection" == b.S()) {
      b = b.vd();
      for (var e = 0, f = b.length; e < f; ++e)fk(a, b[e], c, d)
    } else a.Ja(c.Ba(), "Default").Hh(b, d, c.Ie())
  }
  ...
  var gk = {
    Point: function (a, b, c, d) {
      ...
      var e;
      var f = 0;
      for (e = b.length; f < e; ++f)(0, gk[b[f].S()])(a, b[f], c, d)
  ...
  k.df = function (a, b, c) {
    var d = a.extent, e = a.pixelRatio, f = b.Te ? a.skippedFeatureUids : {},
      g = a.viewState, h = g.projection, l = g.rotation, m = h.G(),
      n = this.a.ha(), p = $i(this, a, 0);
    ...
    if (r && !r.yg()) {
      ...
      qi(A, l, S / 2, e / 2);
      A != c && (z && Zi(this, "render", A, a, p), v ? (d = c.globalAlpha, c.globalAlpha = b.opacity, c.drawImage(A.canvas, -q, -u), c.globalAlpha = d) : c.drawImage(A.canvas,
        -q, -u), A.translate(-q, -u));
      v || (A.globalAlpha = E)
    }
    g && c.restore();
  ...
  k.$c = function (a) {
    ...
    this.c = null;
    this.i = !1;
    var p = new Uj(.5 * l / m, f,
      l, m, c.$, this.f, b.f);
    c.ae(f, l, g);
    a = function (a) {
      var c = a.ib();
      if (c)var d = c.call(a, l); else(c = b.ib()) && (d = c(a, l));
      if (d) {
        if (d) {
          c = !1;
          if (Array.isArray(d))for (var e = 0, f = d.length; e < f; ++e)c = ek(p, a, d[e], dk(l, m), this.Wi, this) || c; else c = ek(p, a, d, dk(l, m), this.Wi, this);
          a = c
        } else a = !1;
        this.i = this.i || a
      }
  ...
  k.Sf = function (a, b, c, d, e, f, g, h, l) {
    var m = a, n = this.a, p = b.pixelRatio, q = b.viewState.projection,
      r = n.g, u = n.get(ik) || null, v = mk(m, n);
    if (v.Be || v.wf != r || v.eh != u) {
      ...
      for (var Ia = 0, ta = m.a.length; Ia < ta; ++Ia) {
        var la = m.c[m.a[Ia]];
        if (3 != la.getState()) {
          var ca = A.Ma(la.ya), ia = gb(E, ca),
            xa = Sa(ca, ia) ? null : Fa(ia, n.f * S), Va = la.o, ic = !1;
          ...
          u && u !== v.eh && Z.sort(u);
          for (var Zb, Le = 0,
                 Uf = Z.length; Le < Uf; ++Le)if (Zb = Z[Le], ic && ("tile-pixels" == Va.a && (Va.Sj(ca), Va.Si(la.G())), Zb.U().mb(Va, q)), !xa || hb(xa, Zb.U().G())) {
            ...
            if (Id) {
              ...
              if (Id) {
                var Mg = !1;
                if (Array.isArray(Id))for (var Ng = 0, Wf = Id.length; Ng < Wf; ++Ng)Mg = ek(Jh, Zb, Id[Ng], te, this.Yi, this) || Mg; else Mg = ek(Jh, Zb, Id, te, this.Yi, this);
                Zb = Mg
              } else Zb = !1;
              this.D = this.D || Zb;
              v.Be = v.Be || Zb
  ...
  k.pf = function (a, b, c) {
    var d = this.a, e = d.D ? {} : null, f = d.ha(), g = d.l, h = lk[g],
      l = b.pixelRatio, m = b.viewState.rotation, n = b.size;
    if (m) {
    ...
    for (var r = [], u = l.length - 1; 0 <= u; --u) {
      var v = l[u];
      if (5 != v.getState())for (var z = v.ya, A = f.Ma(z)[0] - f.Ma(v.l)[0], E = void 0, S = 0, Ia = v.a.length; S < Ia; ++S) {
        var ta = v.c[v.a[S]];
        if (3 != ta.getState()) {
          var la = ok(ta, d, z.toString()), ca;
          if (!(ca = "vector" == g))a:{
            ca = void 0;
            for (ca in la.b)for (var ia = la.b[ca], xa = 0, Va = h.length; xa < Va; ++xa)if (h[xa] in ia) {
              ca = !0;
              break a
            }
            ca = !1
    ...
    if (e)for (d =
                 a, g = Object.keys(e).map(Number).sort(dc), h = {}, l = 0, f = g.length; l < f; ++l)for (n = e[g[l].toString()], r = 0, u = n.length; r < u;)v = n[r++], z = n[r++], v.Na(d, z, m, h);
    m && qi(a, m, p, q);
  ...
  function Dk(a) {
    if ("function" !== typeof a) {
      if (Array.isArray(a))var b = a; else oa(a instanceof Bk, 41), b = [a];
      a = function () {
        return b
      }
    }
  ...
  function Fk() {
    if (!Ek) {
      ...
      Ek = [new Bk({
        image: new yk({fill: a, stroke: b, radius: 5}),
        fill: a,
        stroke: b
      })]
    }
  ...
  function Gk() {
    ...
    }), new Bk({stroke: new Ak({color: c, width: 3})})];
    ...
    a.Point = [new Bk({
      image: new yk({
        radius: 6,
        fill: new zk({color: c}),
        stroke: new Ak({color: b, width: 1.5})
      }), zIndex: Infinity
    })];
  ...
  k.Fe = function () {
    this.j != this.g && (this.c = this.Ph(.5, this.c), this.j = this.g);
    return this.c
  };
  k.xd = function (a) {
    var b = [];
  ...
  function Uk(a, b, c) {
    for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [f, e], m = [h, g], n = [1, 0], p = {}, q = 1E5, r, u, v, z, A; 0 < --q && 0 < n.length;)v = n.pop(), e = l.pop(), g = m.pop(), f = v.toString(), f in p || (d.push(g[0], g[1]), p[f] = !0), z = n.pop(), f = l.pop(), h = m.pop(), A = (v + z) / 2, r = a(A), u = b(r), sa(u[0], u[1], g[0], g[1], h[0], h[1]) < c ? (d.push(h[0], h[1]), f = z.toString(), p[f] = !0) : (n.push(z, A, A, v), m.push(h, u, u, g), l.push(f, r, r, e));
    return d
  }
  ...
  function Xk(a) {
    ...
    1 == a.showLabels && (this.$ = void 0 == a.lonLabelFormatter ? Ce.bind(this, "EW") : a.lonLabelFormatter, this.Wa = void 0 == a.latLabelFormatter ? Ce.bind(this, "NS") : a.latLabelFormatter,
      this.ca = void 0 == a.lonLabelPosition ? 0 : a.lonLabelPosition, this.V = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition, this.B = void 0 !== a.lonLabelStyle ? a.lonLabelStyle : new J({
      font: "12px Calibri,sans-serif",
      textBaseline: "bottom",
      fill: new zk({color: "rgba(0,0,0,1)"}),
      stroke: new Ak({color: "rgba(255,255,255,1)", width: 3})
  ...
  function $k(a, b, c, d, e, f, g) {
    ...
    h.ba("XY", c);
    hb(h.G(), f) && (a.b && (c = g, d = h.da(), f = [d[0], pa(f[1] + Math.abs(f[1] - f[3]) * a.ca, Math.max(f[1], d[1]), Math.min(f[3], d[d.length - 1]))], c = void 0 !== a.b[c] ? a.b[c].Qd : new C(null), c.na(f), a.b[g] = {
      Qd: c,
      text: a.$(b)
    }), a.g[g++] = h);
    return g
  ...
  function al(a, b, c, d, e, f, g) {
    ...
    h.ba("XY", c);
    hb(h.G(), f) && (a.a && (c = g, d = h.da(), f = [pa(f[0] + Math.abs(f[0] - f[2]) * a.V, Math.max(f[0], d[0]), Math.min(f[2], d[d.length - 2])), d[1]], c = void 0 !== a.a[c] ? a.a[c].Qd : new C(null), c.na(f), a.a[g] = {
      Qd: c,
      text: a.Wa(b)
    }), a.c[g++] = h);
    return g
  ...
  k.di = function (a) {
    ...
    if (!this.i || !Xb(this.i, f)) {
      var g = Ob("EPSG:4326"), h = f.G(), l = f.oe, m = bc(l, g, f), n = l[2],
        p = l[1], q = l[0], r = m[3], u = m[2], v = m[1];
      m = m[0];
      this.f = l[3];
      this.j = n;
      this.l = p;
    ...
    if (this.b)for (a = 0, c = this.b.length; a < c; ++a)e = this.b[a], this.B.Hd(e.text), b.nb(this.B), b.Hb(e.Qd);
    if (this.a)for (a = 0, c = this.a.length; a < c; ++a)e = this.a[a], this.C.Hd(e.text), b.nb(this.C), b.Hb(e.Qd)
  };
  k.setMap = function (a) {
  ...
  k.load = function () {
    if (0 == this.state || 3 == this.state) this.state = 1, this.u(), this.g = [Lc(this.M, "error", this.kn, this), Lc(this.M, "load", this.ln, this)], this.c(this, this.i)
  };
  k.ih = function (a) {
    this.M = a
  };
  ...
  k.Bf = function (a, b, c, d) {
    var e = Cl(b, kl, ll);
    if (this.v)var f = this.v; else this.v = f = new ml(a, e);
    b.cd(e);
  ...
  k.Oa = function (a, b) {
    ...
    this.c.strokeColor && jc(this.c.strokeColor, c) && this.c.fillColor && jc(this.c.fillColor, a) && this.c.lineWidth === b || (this.c.u =
  ...
  function Ol(a, b, c, d) {
    var e = a.D, f = a.C, g = a.height, h = a.oa, l = a.qa, m = a.opacity,
      n = a.T, p = a.O, q = a.rotateWithView ? 1 : 0, r = -a.rotation,
      u = a.scale, v = a.width, z = Math.cos(r);
    r = Math.sin(r);
  ...
  k.Bf = function (a, b) {
    var c = Cl(b, El, Fl);
    if (this.Wa)var d = this.Wa; else this.Wa = d = new Gl(a, c);
    b.cd(c);
  ...
  k.Zb = function (a) {
    var b = a.Vc(), c = a.Y(1), d = a.He(), e = a.Eg(), f = a.i, g = a.bd(),
      h = a.s, l = a.f, m = a.oc();
    a = a.a;
  ...
  w(Vl, ql);
  function Wl(a, b, c, d) {
    var e, f = a.a.length, g = a.b.length,
    ...
    for (e = 0; e < c; e += d) {
      ...
      if (0 === e) {
        ...
        m ? v = z : (r = r || [0, 0], f = Xl(a, r, u, [0, 0], p * $l * (l || 1), f), f = Xl(a, r, u, [0, 0], -p * $l * (l || 1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, l && (f = Xl(a, r, u, [0, 0], p * am * l, f), f = Xl(a, r, u, [0, 0], -p * am * l, f), a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = q + 1, a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q + 2));
        break
      } else v = [b[e + d], b[e + d + 1]];
  ...
  k.vc = function (a, b) {
    ...
    if (1 < d.length) {
      var g = 1;
      for (f = d.length; g < f; ++g)if (fm(e, d[g - 1], d[g], a)) {
  ...
  k.Bf = function (a, b, c, d) {
    var e = Cl(b, Sl, Tl);
    if (this.v)var f = this.v; else this.v = f = new Ul(a, e);
    b.cd(e);
  ...
  function Cm(a, b, c, d, e, f) {
    ...
    } else for (p = b.length - c, n = f = Im(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c)q = Im(a, b[p], b[p + 1], h++), m.push(Jm(n, q, d)), l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]), n = q;
    m.push(Jm(q, f, d));
  ...
  function Gm(a, b, c, d, e) {
    ...
    l = f.X;
    if (0 < g && (f = Mm(b, r, f.X, e), f.length))for (r = Infinity, m = 0, h = f.length; m < h; ++m)if (g = f[m], n = Math.atan2(b.y - g.y, d.x - g.x), n < r || n === r && g.x < l.x) r = n, l = g;
  ...
  function Hm(a, b, c) {
    for (var d = !1, e = Nm(b, c); 3 < b.c;)if (e) {
      if (!Om(a, b, c, e, d) && !Em(b, c, d) && !Pm(a, b, c, !0))break
    } else if (!Om(a, b, c, e, d) && !Em(b, c, d) && !Pm(a, b, c))if (e = Nm(b, c)) {
      d = b;
  ...
  function Om(a, b, c, d, e) {
    var f = a.b.length, g = om(b), h = sm(b), l = g, m = pm(b), n = qm(b),
      p = !1;
    do {
      var q = l.Z;
      var r = l.X;
      ...
      if (!1 === r.Kb) {
        ...
        !d && 0 !== Fm({
          Z: q,
          X: u
        }, c).length || !v || !d && !1 !== q.Kb && !1 !== u.Kb && Mf([h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x, n.X.y], 0, 10, 2) !== !e || (a.b[f++] = q.qb, a.b[f++] = r.qb, a.b[f++] = u.qb, Km(l, m, b, c), m === g && (g = n), p = !0)
      }
      h = sm(b);
      l = tm(b);
      m = pm(b);
  ...
  function Jm(a, b, c, d) {
    var e = {Z: a, X: b}, f = {Eb: void 0, next: void 0, data: e}, g = c.b;
    if (g) {
      var h = g.next;
      f.Eb = g;
      f.next = h;
  ...
  function Lm(a, b, c, d, e) {
    ...
    if (0 !== f && (d = ((d.x - c.x) * (a.y - c.y) - (d.y - c.y) * (a.x - c.x)) / f, c = ((b.x - a.x) * (a.y - c.y) - (b.y - a.y) * (a.x - c.x)) / f, !e && d > xl && d < 1 - xl && c > xl && c < 1 - xl || e && 0 <= d && 1 >= d && 0 <= c && 1 >= c))return [a.x + d * (b.x - a.x), a.y + d * (b.y - a.y)]
  }
  ...
  k.Bf = function (a, b) {
    var c = Cl(b, jm, km);
    if (this.v)var d = this.v; else this.v = d = new lm(a, c);
    b.cd(c);
    a.enableVertexAttribArray(d.b);
  ...
  k.Wb = function (a, b) {
    if (this.ta) {
      ...
      a = this.l;
      b = this.ta.split("\n");
      var f = Ym(this, b), g, h, l = Math.round(f[0] * this.ab - this.$),
  ...
  function dn(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    for (r = q.length; v < r; ++v) {
      ...
      for (u = uj.length - 1; 0 <= u; --u) {
        var A = z[uj[u]];
        if (void 0 !== A && (A = A.Na(b, c, d, e, p, f, g, h, l, m, n)))return A
      }
    }
  }
  ...
  mn.prototype.Zi = function (a, b, c) {
    ...
    if (this.o)var f = this.o; else this.o = f = new ln(d, e);
  ...
  pn.prototype.Bg = function (a, b) {
    var c = this.c.g, d = a.pixelRatio, e = a.viewState, f = e.center,
      g = e.resolution, h = e.rotation, l = this.M, m = this.Mb,
      n = this.a.ha(), p = a.viewHints, q = a.extent;
    ...
    l && (c = this.c.i.j, rn(this, c.width, c.height, d, f, g, h, l.G()), this.l = null, d = this.v, Xe(d), cf(d, 1, -1), df(d, 0,
      -1), this.M = l, this.Mb = m, Ui(a, n));
    return !!l
  };
  ...
  pn.prototype.zg = function (a, b, c, d) {
    if (this.M && this.M.Y())if (this.a.ha().wa !== ea) {
      var e = af(b.pixelToCoordinateTransform, a.slice());
      if (this.wa(e, b, 0, Re, this))return c.call(d, this.a, null)
    } else {
  ...
  function tn(a, b, c, d) {
    var e = a.g, f = b.lb();
    if (a.a.a.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Mb), 9729 != a.hi && (e.texParameteri(3553, 10240, 9729), a.hi = 9729), 9729 != a.ji && (e.texParameteri(3553, 10241, 9729), a.ji = 9729); else {
  ...
  k.Yk = function (a, b) {
    ...
    for (var c; 1024 < this.a.i - this.f;) {
      if (c = this.a.g.Pc) a.deleteTexture(c.Mb); else if (+this.a.g.jc == b.index)break; else--this.f;
      this.a.pop()
    }
  };
  k.S = function () {
  ...
  k.wa = function (a, b, c, d, e, f, g) {
    ...
    for (m = l.length - 1; 0 <= m; --m) {
      var n = l[m];
      var p = n.layer;
      if (yg(n, h.resolution) && f.call(g, p) && (n = ij(this, p).wa(a, b, c, d, e)))return n
    }
  };
  k.Ui = function (a, b, c, d, e) {
    c = !1;
  ...
  k.Bg = function (a, b, c) {
    var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a,
      l = h.ha(), m = l.eb(g), n = m.Dc(f.resolution), p = m.Ta(n),
      q = l.Zd(n, a.pixelRatio, g), r = q[0] / Ba(m.Za(n), this.O)[0],
      u = p / r, v = l.Xc(r) * l.Zf(g), z = f.center, A = a.extent,
      E = tc(m, A, n);
    if (this.l && na(this.l, E) && this.s == l.g) u = this.D; else {
      ...
      for (Va = E.fa; Va <= E.la; ++Va)for (ic = E.ea; ic <= E.ka; ++ic) {
        ta = l.ad(n, Va, ic, r, g);
        if (void 0 !== b.extent) {
      ...
      var Z;
      ia = 0;
      for (xa = b.length; ia < xa; ++ia)for (Z in Va = c[b[ia]], Va)ta = Va[Z], Xa = m.Ma(ta.ya, la), ca[0] = 2 * (Xa[2] - Xa[0]) / S, ca[1] = 2 * (Xa[3] - Xa[1]) / S, ca[2] = 2 * (Xa[0] - u[0]) /
  ...
  k.zg = function (a, b, c, d) {
    a = af(b.pixelToCoordinateTransform, a.slice());
    if (this.cf(a, b))return c.call(d, this.a, null)
  };
  k.$i = function () {
    Mi(this)
  };
  k.Bg = function (a, b, c) {
    function d(a) {
      var b = a.ib();
      if (b)var c = b.call(a, m); else(b = e.ib()) && (c = b(a, m));
      if (c) {
        if (c) {
          b = !1;
          if (Array.isArray(c))for (var d = c.length - 1; 0 <= d; --d)b = ek(q, a, c[d], dk(m, n), this.$i, this) || b; else b = ek(q, a, c, dk(m, n), this.$i, this) || b;
          a = b
        } else a = !1;
        this.s = this.s || a
      }
  ...
  k.qm = function () {
    ...
    if (this.get(Fn) && this.autoPan) {
      var a = this.Ve();
      if (a && a.Cc()) {
        var b = In(a.Cc(), a.Cb()), c = this.Rd(), d = c.offsetWidth,
        ...
        b[0] && 0 === b[1]) || (c = a.aa().xa(), c = a.Ia(c), b = [c[0] + b[0], c[1] + b[1]], a.aa().animate({
          center: a.Ra(b),
  ...
  function Hn(a) {
    ...
    if (b && b.c && c) {
      ...
      var g = e[0];
      e = e[1];
      if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Se && (a.a.Se = b.left = ""), g = Math.round(d[0] - c[0] - g) + "px", a.a.xf != g && (a.a.xf = b.right = g); else {
      ...
      if ("bottom-left" == f || "bottom-center" ==
        f || "bottom-right" == f) "" !== a.a.Ef && (a.a.Ef = b.top = ""), c = Math.round(d[1] - c[1] - e) + "px", a.a.ze != c && (a.a.ze = b.bottom = c); else {
  ...
  var Cn = "element", Dn = "map", En = "offset", Fn = "position",
    Gn = "positioning";
  ...
  function Wn(a) {
    ...
    var h = this.c = new G({
      controls: new B, interactions: new B,
      view: a.view
    });
  ...
  function io(a) {
    if (a.frameState) {
      if (!this.$) {
        var b = this.element, c = b.offsetWidth, d = b.offsetHeight,
          e = b.firstElementChild, f = getComputedStyle(e);
  ...
  function Jo(a, b, c) {
    var d = c ? Ob(c.featureProjection) : null,
      e = c ? Ob(c.dataProjection) : null, f;
  ...
  function Ii(a) {
    if (a.T != a.g) {
      ...
      a:{
        ...
        var d;
        var e = 0;
        for (d = c.length; e < d; ++e)if (!Nf(b, c[e], a.a, void 0)) {
          c = !1;
          break a
        }
        c = !0
  ...
  function Qo(a, b) {
    ...
    if ("number" === typeof a.x && "number" === typeof a.y)var c = "Point"; else if (a.points) c = "MultiPoint"; else if (a.paths) c = 1 === a.paths.length ? "LineString" : "MultiLineString"; else if (a.rings) {
      ...
      for (; c.length;) {
        d = c.shift();
        e = !1;
        for (l = g.length - 1; 0 <= l; l--)if (La((new Df(g[l][0])).G(), (new Df(d)).G())) {
          g[l].push(d);
          e = !0;
          break
        }
  ...
  function Yo(a, b, c) {
    var d = [];
    for (b = b.firstChild; b; b = b.nextSibling)b.nodeType == Node.ELEMENT_NODE && gc(d, a.Kc(b, c));
    return d
  }
  
  k.ed = function (a, b) {
    if (qo(a))return null;
    if (ro(a))return this.vj(a, b);
  ...
  k.Aj = function (a, b) {
    if (a = this.qf(a, b))return b = new C(null), b.ba("XYZ", a), b
  };
  k.yj = function (a, b) {
    if (a = O([], this.kk, a, b, this))return new No(a)
  };
  k.xj = function (a, b) {
    if (a = O([], this.jk, a, b, this))return b = new P(null), Mo(b, a), b
  };
  k.zj = function (a, b) {
    if (a = O([], this.lk, a, b, this))return b = new Q(null), Oo(b, a), b
  };
  k.qj = function (a, b) {
    Co(this.pk, a, b, this)
  };
  ...
  k.sf = function (a, b) {
    if (a = this.qf(a, b))return b = new I(null), b.ba("XYZ", a), b
  };
  k.Xp = function (a, b) {
    if (a = O(null, this.te, a, b, this))return a
  };
  k.wj = function (a, b) {
    if (a = this.qf(a, b))return b = new Df(null), Ef(b, "XYZ", a), b
  };
  k.tf = function (a, b) {
  ...
  k = Kp.prototype;
  k.aq = function (a, b) {
    if (a = O([], this.ik, a, b, this))return b = new P(null), Mo(b, a), b
  };
  k.bq = function (a, b) {
    if (a = O([], this.mk, a, b, this))return b = new Q(null), Oo(b, a), b
  };
  k.Gh = function (a, b) {
    Co(this.ek, a, b, this)
  };
  ...
  k.tj = function (a, b) {
    if (a = O([null], this.fk, a, b, this))return b = new I(null), b.ba("XYZ", a), b
  };
  k.Wp = function (a, b) {
  ...
  var qq = {rte: kq, trk: mq, wpt: oq},
    ...
    iq = N(eq, {text: L(R, "linkText"), type: L(R, "linkType")}), lq = N(eq, {
      name: L(R),
      cmt: L(R),
      desc: L(R),
      src: L(R),
    ...
    }), sq = N(eq, {ele: L(dp), time: L(cp)}), nq = N(eq, {
      name: L(R),
      cmt: L(R),
      desc: L(R),
      src: L(R),
    ...
    }), uq = N(eq, {ele: L(dp), time: L(cp)}), pq = N(eq, {
      ele: L(dp),
      time: L(cp),
      magvar: L(dp),
      geoidheight: L(dp),
  ...
  var yq = ["text", "type"], xq = N(eq, {text: M(ip), type: M(ip)}),
    ...
    Iq = N(eq, {
      ...
      trkseg: xo(M(function (a, b, c) {
        Do({node: a, geometryLayout: b.ja, properties: {}}, Gq, Hq, b.W(), c)
      }))
    }), Hq = yo("trkpt"),
    Gq = N(eq, {trkpt: M(zq)}),
  ...
  function Kq(a, b) {
    if (a = a.U())if (a = Jq[a.S()])return no(b[b.length - 1].node.namespaceURI, a)
  }
  ...
  function Pq(a) {
    ...
    if (a.a) {
      var c = 0;
      for (b = a.a.length; c < b; ++c)Mc(a.a[c], "change", a.u, a)
    }
  }
  ...
  function Nq(a) {
    ...
    if (a.a) {
      var c = 0;
      for (b = a.a.length; c < b; ++c)y(a.a[c], "change", a.u, a)
    }
  }
  ...
  k.Zc = function (a, b) {
    var c = this.a, d;
    var e = 0;
    for (d = c.length; e < d; ++e)if (c[e].Zc(a, b))return !0;
    return !1
  };
  k.Ae = function (a) {
    Oa(a);
    for (var b = this.a, c = 0, d = b.length; c < d; ++c)Ta(a, b[c].G());
    return a
  };
  k.vd = function () {
    return Oq(this.a)
  ...
  k.$a = function (a) {
    var b = this.a, c;
    var d = 0;
    for (c = b.length; d < c; ++d)if (b[d].$a(a))return !0;
    return !1
  };
  k.rotate = function (a, b) {
  ...
  var Yq = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/,
    Zq = /^H.([A-Z]{3}).*?:(.*)/, $q = /^HFDTE(\d{2})(\d{2})(\d{2})/,
    ar = /\r\n|\r|\n/;
  k = Xq.prototype;
  k.fe = function (a, b) {
  ...
  function dr(a) {
    ...
    var b = void 0 !== a.img ? a.img : null,
      c = void 0 !== a.imgSize ? a.imgSize : null, d = a.src;
    oa(!(void 0 !== d && b), 4);
    oa(!b || b && c, 5);
  ...
  function er(a) {
    a = a ? a : {};
    Wo.call(this);
    fr || (gr = [255, 255, 255, 1], hr = new zk({color: gr}), ir = [20, 2], jr = kr = "pixels", lr = [64, 64], mr = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", nr = .5, or = new dr({
      anchor: ir,
      ...
      fill: hr,
      image: or, text: sr, stroke: qr, zIndex: 0
    }), fr = [tr]);
    this.defaultDataProjection = Ob("EPSG:4326");
  ...
  function Ir(a, b) {
    var c = O({}, Jr, a, b);
    if (a = O(null, Kr, a, b))return b = new I(null), b.ba("XYZ", a), b.H(c), b
  }
  
  function Lr(a, b) {
    var c = O({}, Jr, a, b);
    if (a = O(null, Kr, a, b))return b = new D(null), b.ba("XYZ", a, [a.length]), b.H(c), b
  }
  ...
  function Mr(a, b) {
    ...
    if (c)if ("Point" == d) {
      ...
      g.ba(c, d);
      Or(g, a)
    } else"LineString" == d ? (g = new P(null), Mo(g, a), Or(g, a)) : "Polygon" == d ? (g = new Q(null), Oo(g, a), Or(g, a)) : "GeometryCollection" == d ? g = new Mq(a) : oa(!1, 37); else g = new Mq(a);
    return g
  }
  
  function Pr(a, b) {
    var c = O({}, Jr, a, b);
    if (a = O(null, Kr, a, b))return b = new C(null), b.ba("XYZ", a), b.H(c), b
  }
  ...
  function Or(a, b) {
    var c = b.length, d = Array(b.length), e = Array(b.length),
      f = Array(b.length), g, h, l;
    var m = h = l = !1;
    for (g = 0; g < c; ++g) {
      var n = b[g];
      d[g] = n.get("extrude");
  ...
  var Yr = N(vr, {displayName: L(R), value: L(R)}), Vr = N(vr, {
      Data: function (a, b) {
      ...
      LatLonAltBox: function (a, b) {
        if (a = O({}, $r, a, b)) b = b[b.length - 1], b.extent = [parseFloat(a.west), parseFloat(a.south), parseFloat(a.east), parseFloat(a.north)], b.altitudeMode = a.altitudeMode, b.minAltitude = parseFloat(a.minAltitude), b.maxAltitude = parseFloat(a.maxAltitude)
      },
      Lod: function (a, b) {
        if (a = O({}, as, a, b)) b = b[b.length - 1], b.minLodPixels = parseFloat(a.minLodPixels), b.maxLodPixels = parseFloat(a.maxLodPixels), b.minFadeExtent = parseFloat(a.minFadeExtent), b.maxFadeExtent = parseFloat(a.maxFadeExtent)
      }
    }), $r = N(vr, {
      altitudeMode: L(R),
      minAltitude: L(dp),
    ...
    es = N(vr, {
      ...
      }), heading: L(dp), hotSpot: L(function (a) {
    ...
    bs = N(vr, {LinearRing: vo(Er)}), fs = N(vr, {color: L(Ar), scale: L(Dr)}),
    gs = N(vr, {color: L(Ar), width: L(dp)}), Nr = N(vr, {
      LineString: uo(Ir),
      LinearRing: uo(Lr),
      MultiGeometry: uo(Mr),
      Point: uo(Pr),
      ...
      phoneNumber: L(R),
      visibility: L(ap)
    }), is = N(vr, {href: L(Cr)}), cs = N(vr, {LinearRing: vo(Er)}),
    ks = N(vr, {Style: L(Sr), key: L(R), styleUrl: L(Cr)}), ms = N(vr, {
      ExtendedData: Ur,
      Region: Wr,
      ...
      StyleMap: function (a, b) {
        if (a = O(void 0, ls, a, b)) b = b[b.length - 1], Array.isArray(a) ? b.Style = a : "string" === typeof a ? b.styleUrl = a : oa(!1, 38)
      },
      address: L(R),
      description: L(R),
      name: L(R),
      ...
      MultiTrack: L(function (a, b) {
        if (a = O([], hs, a, b))return b = new P(null), Mo(b, a), b
      }, "geometry"), Track: L(Gr, "geometry")
    })),
    ns = N(vr, {color: L(Ar), fill: L(ap), outline: L(ap)}), Zr = N(vr, {
      ...
      IconStyle: function (a, b) {
        if (a = O({}, es, a, b)) {
          ...
          var c = "Icon" in a ? a.Icon : {},
            d = !("Icon" in a) || 0 < Object.keys(c).length, e, f = c.href;
          f ? e = f : d && (e = mr);
          f = "bottom-left";
          var g = a.hotSpot;
          if (g) {
  ...
  k.cq = function (a) {
    if (qo(a))return os(this, a);
    if (ro(a))return ps(this, a);
    if ("string" === typeof a)return a = so(a), os(this, a)
  };
  function os(a, b) {
  ...
  function ps(a, b) {
    var c;
    for (c = b.firstElementChild; c; c = c.nextElementSibling)if (ec(vr, c.namespaceURI) && "name" == c.localName)return R(c);
    for (c = b.firstElementChild; c; c = c.nextElementSibling)if (b = c.localName, ec(vr, c.namespaceURI) && ("Document" == b || "Folder" == b || "Placemark" == b || "kml" == b) && (b = ps(a, c)))return b
  }
  ...
  function qs(a, b) {
    var c = [];
    for (b = b.firstChild; b; b = b.nextSibling)b.nodeType == Node.ELEMENT_NODE && gc(c, rs(a, b));
    return c
  }
  
  function rs(a, b) {
    var c, d = [];
    for (c = b.firstElementChild; c; c = c.nextElementSibling)if (ec(vr, c.namespaceURI) && "NetworkLink" == c.localName) {
      var e = O({}, js, c, []);
      d.push(e)
    }
  ...
  function ss(a, b) {
    var c = [];
    for (b = b.firstChild; b; b = b.nextSibling)b.nodeType == Node.ELEMENT_NODE && gc(c, a.vf(b));
    return c
  }
  
  k.vf = function (a) {
    var b, c = [];
    for (b = a.firstElementChild; b; b = b.nextElementSibling)if (ec(vr, b.namespaceURI) && "Region" == b.localName) {
      var d = O({}, Xr, b, []);
      c.push(d)
    }
  ...
  function us(a, b, c) {
    ...
    if ("GeometryCollection" == d) {
      var e = b.vd();
      var f = vs
    } else"MultiPoint" == d ? (e = b.de(), f = ws) : "MultiLineString" == d ? (e = b.wd(), f = xs) : "MultiPolygon" == d ? (e = b.Vd(), f = ys) : oa(!1, 39);
    Do(a, zs, f, e, c)
  }
  ...
  function Ds(a, b, c) {
    ...
    if (f = b.ib())if (f = f.call(b, 0)) f = Array.isArray(f) ? f[0] : f, this.j && (a.Style = f), (f = f.Ka()) && (a.name = f.Ka());
  ...
  var Ps = N(vr, ["Document", "Placemark"]), Ss = N(vr, {
    ...
    Xs = N(vr, ["scale", "heading", "Icon", "hotSpot"]), Zs = N(vr, {
      Icon: M(function (a, b, c) {
        ...
        Do(a, Ws,
          Ys, e, c, d)
      }), heading: M(Ip), hotSpot: M(function (a, b) {
        a.setAttribute("x", b.x);
        a.setAttribute("y", b.y);
        a.setAttribute("xunits", b.oh);
        a.setAttribute("yunits", b.ph)
      }), scale: M(Os)
    }), $s = N(vr, ["color", "scale"]), at = N(vr, {color: M(ts), scale: M(Os)}),
    bt = N(vr, ["color", "width"]), ct = N(vr, {color: M(ts), width: M(Ip)}),
    ...
    Es = N(vr,
      {
        ExtendedData: M(function (a, b, c) {
          ...
          var d = b.names;
          b = b.values;
          for (var e = d.length, f = 0; f < e; f++)Do(a, Ts, dt, [{
            name: d[f],
            value: b[f]
          }], c)
        }),
  ...
  function vs(a, b) {
    if (a)return no(b[b.length - 1].node.namespaceURI, Us[a.S()])
  }
  
  var ht = yo("color"), dt = yo("Data"), Fs = yo("ExtendedData"),
    Ms = yo("innerBoundaryIs"), ws = yo("Point"), xs = yo("LineString"),
    Cs = yo("LinearRing"), ys = yo("Polygon"), Ns = yo("outerBoundaryIs");
  ...
  (function (a) {
    ...
    b.prototype = {
      Og: function (a,
        ...
        a &= 7;
        if (a === b.c)for (; 127 < this.tc[this.ga++];); else if (a === b.b) this.ga = this.Ua() + this.ga; else if (a === b.a) this.ga += 4; else if (a === b.g) this.ga += 8; else throw Error("Unimplemented type: " +
          a);
      }
    };
    a["default"] = b
  ...
  function lt(a, b, c) {
    if (15 === a) b.version = c.Ua(); else if (1 === a) b.name = c.Vg(); else if (5 === a) b.extent = c.Ua(); else if (2 === a) b.features.push(c.ga); else if (3 === a) b.keys.push(c.Vg()); else if (4 === a) {
      a = null;
  ...
  function mt(a, b, c) {
    if (1 == a) b.id = c.Ua(); else if (2 == a)for (a = c.Ua() + c.ga; c.ga < a;) {
  ...
  du.prototype.j = function (a) {
    if (qo(a))return fu(a);
    if (ro(a))return O({}, gu, a, []);
    if ("string" === typeof a)return a = so(a), fu(a)
  };
  du.prototype.f = function (a) {
    if (qo(a))return hu(this, a);
    if (ro(a))return iu(this, a);
    if ("string" === typeof a)return a = so(a), hu(this, a)
  };
  function hu(a, b) {
    for (b = b.firstChild; b; b = b.nextSibling)if (b.nodeType == Node.ELEMENT_NODE)return iu(a, b)
  }
  ...
  var ku = {
    ...
    "http://www.opengis.net/wfs": {
      TransactionSummary: L(function (a, b) {
        return O({}, ku, a, b)
      }, "transactionSummary"), InsertResults: L(function (a, b) {
        return O([], mu, a, b)
      }, "insertIds")
    }
  };
  ...
  function fu(a) {
    for (a = a.firstChild; a; a = a.nextSibling)if (a.nodeType == Node.ELEMENT_NODE)return O({}, gu, a, [])
  }
  ...
  var su = {
    "http://www.opengis.net/wfs": {
      Query: M(function (a, b, c) {
        var d = c[c.length - 1], e = d.featurePrefix, f = d.featureNS,
          g = d.propertyNames, h = d.srsName;
  ...
  du.prototype.v = function (a, b, c, d) {
    var e = [], f = no("http://www.opengis.net/wfs", "Transaction"),
      g = d.version ? d.version : "1.1.0", h = "1.0.0" === g ? 2 : 3;
  ...
  var Pu = {
    Point: Lu, LineString: Mu, Polygon: Nu, MultiPoint: function (a) {
      var b = [];
      a = a.de();
  ...
  k.Hp = function () {
    if (Vu(this, 2)) {
      var a;
      if (2 == this.b.type)for (a = [this.Hg()]; Vu(this, 5);)a.push(this.Hg()); else a = av(this);
      if (Vu(this, 3))return a
    } else if (Wu(this))return [];
    throw Error(Xu(this));
  };
  ...
  k.Ip = function () {
    if (Vu(this, 2)) {
      for (var a = [this.Ig()]; Vu(this, 5);)a.push(this.Ig());
      if (Vu(this, 3))return a
    } else if (Wu(this))return [];
    throw Error(Xu(this));
  };
  function $u(a) {
    for (var b = [], c = a.a.length, d = 0; d < c; ++d) {
      var e = a.b;
      if (Vu(a, 4)) b.push(e.value); else break
    }
  ...
  function av(a) {
    for (var b = [$u(a)]; Vu(a, 5);)b.push($u(a));
    return b
  }
  
  function bv(a) {
    for (var b = [a.Gg()]; Vu(a, 5);)b.push(a.Gg());
    return b
  }
  ...
  var nv = [null, "http://www.opengis.net/wms"], fv = N(nv, {
    ...
    }), uv = N(nv, {ContactPerson: L(R), ContactOrganization: L(R)}), vv = N(nv, {
      AddressType: L(R),
      Address: L(R),
      City: L(R),
      StateOrProvince: L(R),
      ...
      AuthorityURL: wo(function (a, b) {
        if (b = gv(a, b))return b.name = a.getAttribute("name"), b
      }),
      Identifier: wo(R),
      MetadataURL: wo(function (a, b) {
        if (b = gv(a, b))return b.type = a.getAttribute("type"), b
      }),
      DataURL: wo(gv),
      ...
      Layer: wo(function (a, b) {
        ...
        if (d)return b = bp(a.getAttribute("queryable")), void 0 === b && (b = c.queryable), d.queryable = void 0 !== b ? b : !1, b = gp(a.getAttribute("cascaded")), void 0 === b && (b = c.cascaded), d.cascaded = b, b = bp(a.getAttribute("opaque")), void 0 === b && (b = c.opaque), d.opaque = void 0 !== b ? b : !1, b = bp(a.getAttribute("noSubsets")), void 0 === b && (b = c.noSubsets), d.noSubsets =
          void 0 !== b ? b : !1, (b = ep(a.getAttribute("fixedWidth"))) || (b = c.fixedWidth), d.fixedWidth = b, (a = ep(a.getAttribute("fixedHeight"))) || (a = c.fixedHeight), d.fixedHeight = a, ["Style", "CRS", "AuthorityURL"].forEach(function (a) {
    ...
    jv = N(nv, {
      Format: wo(R), DCPType: wo(function (a, b) {
        return O({}, zv, a, b)
      })
    }), zv = N(nv, {
      HTTP: L(function (a, b) {
    ...
    }), Av = N(nv, {Get: L(gv), Post: L(gv)}), yv = N(nv, {
      Name: L(R),
      Title: L(R),
      Abstract: L(R),
      LegendURL: wo(kv),
  ...
  var Ev = [null, "http://www.opengis.net/ows/1.1"], Dv = N(Ev, {
  ...
  }), Lv = N(Ev, {Voice: L(R), Facsimile: L(R)}), Pv = N(Ev, {
    Constraint: wo(function (a, b) {
      var c = a.getAttribute("name");
      if (c)return O({name: c}, Kv, a, b)
    })
  }), Rv = N(Ev,
    {
      IndividualName: L(R), PositionName: L(R), ContactInfo: L(function (a, b) {
      return O({}, Mv, a, b)
    })
    }), Fv = N(Ev, {
    Abstract: L(R),
  ...
  var Vv = [null, "http://www.opengis.net/wmts/1.0"],
    Wv = [null, "http://www.opengis.net/ows/1.1"], Tv = N(Vv, {
      ...
      Style: wo(function (a, b) {
        if (b = O({}, $v, a, b))return a = "true" === a.getAttribute("isDefault"), b.isDefault = a, b
      }), Format: wo(R), TileMatrixSetLink: wo(function (a, b) {
        return O({}, aw, a, b)
      ...
      Title: L(R), Abstract: L(R), WGS84BoundingBox: L(function (a, b) {
        a = O([], cw, a, b);
        if (2 == a.length)return Ca(a)
      }), Identifier: L(R)
    })), $v = N(Vv, {
    ...
    }, N(Wv, {Title: L(R), Identifier: L(R)})), aw = N(Vv, {
      TileMatrixSet: L(R), TileMatrixSetLimits: L(function (a, b) {
        return O([],
          dw, a, b)
      })
    }), dw = N(Vv, {
    ...
    cw = N(Wv, {LowerCorner: uo(Uv), UpperCorner: uo(Uv)}), Zv = N(Vv, {
      WellKnownScaleSet: L(R), TileMatrix: wo(function (a, b) {
        return O({}, fw, a, b)
      })
    }, N(Wv, {SupportedCRS: L(R), Identifier: L(R)})), fw = N(Vv, {
      TopLeftCorner: L(Uv),
  ...
  k.Nb = function (a, b, c, d) {
    ...
    b = a * a + f * f;
    if (b < d) {
      if (0 === b)for (d = 0; d < this.a; ++d)c[d] = e[d]; else for (d = this.Bd() / Math.sqrt(b), c[0] = e[0] + d * a, c[1] = e[1] + d * f, d = 2; d < this.a; ++d)c[d] = e[d];
      c.length = this.a;
      return b
    }
    return d
  ...
  function vw(a, b) {
    if (!b)return null;
    if (b instanceof Ec)return a.v = [b], function () {
      return [b.og]
    };
    if (Array.isArray(b)) {
  ...
  k.clear = function (a) {
    if (a) {
      ...
      for (var c in this.f)this.Yg(this.f[c])
    }
    this.i && this.i.clear();
    this.a && this.a.clear();
    this.B.clear();
  ...
  function Cw(a, b, c) {
    a.ec([b[0], b[1], b[0], b[1]], function (a) {
      if (a.U().Bb(b))return c.call(void 0, a)
    })
  }
  
  k.ec = function (a, b, c) {
    if (this.a)return zm(this.a, a, b, c);
    if (this.i)return this.i.forEach(b, c)
  };
  k.Mh = function (a, b, c) {
    return this.ec(a, function (d) {
      if (d.U().$a(a) && (d = b.call(c, d)))return d
    })
  };
  k.Th = function () {
    return this.i
  ...
  k.ee = function () {
    if (this.i)var a = this.i.a; else this.a && (a = wm(this.a), nb(this.f) || gc(a, mb(this.f)));
    return a
  };
  k.Sh = function (a) {
    var b = [];
  ...
  k.Oh = function (a, b) {
    var c = a[0], d = a[1], e = null, f = [NaN, NaN], g = Infinity,
      h = [-Infinity, -Infinity, Infinity, Infinity], l = b ? b : Re;
  ...
  function Ew(a) {
    ...
    if (!b)if ("Circle" === this.O) b = function (a, b) {
  ...
  function Pw(a, b) {
    b = b.coordinate;
    a.s = b;
    a.f === Kw ? a.a = b.slice() : a.f === Jw ? (a.a = [[b.slice(), b.slice()]], a.T = a.a[0]) : (a.a = [b.slice(), b.slice()], a.f === Qw && (a.T = a.a));
  ...
  function gx(a) {
    ...
    this.B = new T({
      source: new U({useSpatialIndex: !1, wrapX: !!a.wrapX}), style: a.style ?
        a.style : lx(), updateWhileAnimating: !0, updateWhileInteracting: !0
    });
    this.ca = {
      Point: this.io,
      LineString: this.Mi,
  ...
  k.bo = function (a, b) {
    var c = b.xa(), d = {feature: a, geometry: b, index: 0, ma: [c, c]};
  ...
  k.co = function (a, b) {
    var c = b.a;
    for (b = 0; b < c.length; ++b)this.ca[c[b].S()].call(this, a, c[b])
  };
  function rx(a, b) {
    var c = a.f;
  ...
  function hx(a) {
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        p && (n += "-" + p.join("-"));
        f[n] || (f[n] = Array(2));
        if ("Circle" === l.geometry.S() && 1 === l.index) m = tx(b, l), Ee(m, c) && !f[n][0] && (this.j.push([l, 0]), f[n][0] = l); else if (Ee(m[0], c) && !f[n][0]) this.j.push([l, 0]), f[n][0] = l; else if (Ee(m[1], c) &&
          !f[n][1]) {
          if ("LineString" !== l.geometry.S() && "MultiLineString" !== l.geometry.S() || !f[n][0] || 0 !== f[n][0].index) this.j.push([l, 1]), f[n][1] = l
        } else this.sc(a) && x(m) in this.La && !f[n][0] && !f[n][1] && d.push([l, c])
      }
      d.length && nx(this, a);
  ...
  function mx(a, b, c) {
    ...
    if (0 < f.length) {
      ...
      if (n <= a.ra) {
        b = {};
        if ("Circle" === g.geometry.S() && 1 === g.index) a.ua = !0, rx(a, l); else for (n = c.Ia(h[0]), g = c.Ia(h[1]), c = He(m, n), m = He(m, g), n = Math.sqrt(Math.min(c, m)), a.ua = n <= a.ra, a.ua && (l = c > m ? h[1] : h[0]), rx(a, l), m = 1, c = f.length; m < c; ++m)if (l = f[m].ma, Ee(h[0], l[0]) && Ee(h[1], l[1]) || Ee(h[0], l[1]) && Ee(h[1], l[0])) b[x(l)] = !0; else break;
        b[x(h)] = !0;
        a.La = b;
        return
      }
  ...
  function xx(a) {
    ...
    var b = this.D(a), c = this.B(a), d = this.T(a), e = !b && !c && !d,
      f = a.map, g = this.f.ha().i, h = [], l = [];
    if (e) {
      lb(this.a);
      f.Tc(a.pixel, function (a, b) {
        if (this.l(a, b))return l.push(a), a = x(a), this.a[a] = b, !this.s
  ...
  k.Ni = function (a) {
    if (a instanceof Bw)var b = a.feature; else a instanceof cd && (b = a.element);
    this.Gb(b)
  };
  k.Oi = function (a) {
    if (a instanceof Bw)var b = a.feature; else a instanceof cd && (b = a.element);
  ...
  k.jd = Se;
  function Fx(a, b, c, d) {
    var e = d.Ra([b[0] - a.f, b[1] + a.f]), f = d.Ra([b[0] + a.f, b[1] - a.f]);
    e = Ca([e, f]);
    var g = xm(a.a, e);
    ...
    if (0 < g.length) {
      ...
      if (a.O && !a.C) {
        if (c = d.Ia(m[0]), h = d.Ia(m[1]), c = He(b, c), b = He(b, h), h = Math.sqrt(Math.min(c, b)), h = h <= a.f) e = !0, f = c > b ? m[1] : m[0], l = d.Ia(f)
      } else a.C && (f = h ? Ae(c, g[0].feature.U()) : Be(c, m), l = d.Ia(f), Ie(b, l) <= a.f && (e = !0, a.O &&
  ...
  function Lx(a, b, c) {
    return c.Tc(b, function (a) {
      if (!this.j || ec(this.j.a, a))return a
    }.bind(a), {layerFilter: a.C, hitTolerance: a.s})
  }
  ...
  function Vx(a, b) {
    for (var c = a.length, d = Array(c), e = 0; e < c; ++e)d[e] = Ux(a[e], b);
    return Wx(d)
  }
  ...
  function dy(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    h.c.forEach(function (a) {
      var b = a.source, e = a.target, g = b[1][0], h = b[1][1], l = b[2][0],
        m = b[2][1];
      a = (e[0][0] -
        v[0]) / f;
      var n = -(e[0][1] - v[1]) / f, u = (e[1][0] - v[0]) / f,
        z = -(e[1][1] - v[1]) / f, Va = (e[2][0] - v[0]) / f,
        ic = -(e[2][1] - v[1]) / f;
      e = b[0][0];
      b = b[0][1];
      g -= e;
      ...
      a:{
        ...
        for (l = 0; l < h; l++) {
          ...
          g[m] = g[l];
          g[l] = Xa;
          for (m = l + 1; m < h; m++)for (Xa = -g[m][l] / g[l][l], Z = l; Z < h + 1; Z++)g[m][Z] = l == Z ? 0 : g[m][Z] + Xa * g[l][Z]
        }
        l = Array(h);
        for (m = h - 1; 0 <=
        m; m--)for (l[m] = g[m][h] / g[m][m], Xa = m - 1; 0 <= Xa; Xa--)g[Xa][h] -= g[Xa][m] * l[m];
        g = l
      }
  ...
  function fy(a, b, c, d, e, f, g, h, l, m) {
    var n = Ca([f, g, h, l]), p = a.b ? cb(n) / a.b : null, q = a.b,
      r = a.g.g && .5 < p && 1 > p, u = !1;
    if (0 < m) {
      if (a.i.c && a.j) {
        var v = Ca([b, c, d, e]);
    ...
    if (u || !a.f || hb(n, a.f)) {
      ...
      if (0 < m && (u || (n = a.a([(b[0] + d[0]) / 2, (b[1] + d[1]) / 2]), q = r ? (wa(f[0], q) + wa(h[0], q)) / 2 - wa(n[0], q) : (f[0] + h[0]) / 2 - n[0], n = (f[1] + h[1]) / 2 - n[1],
          u = q * q + n * n > a.v), u)) {
        Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1]) ? (r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], q = a.a(r), n = [(e[0] + b[0]) / 2, (e[1] + b[1]) / 2], p = a.a(n), fy(a, b, c, r, n, f, g, q, p, m - 1), fy(a, n, r, d, e, p, q, h, l, m - 1)) : (r = [(b[0] + c[0]) / 2, (b[1] + c[1]) / 2], q = a.a(r), n = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2], p = a.a(n), fy(a, b, r, n, e, f, q, p, l, m - 1), fy(a, r, c, d, n, q, g, h, p, m - 1));
        return
      }
      if (r) {
        if (!a.s)return;
  ...
  function hy(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    if (0 === ab(f)) this.state = 4; else if ((h = a.G()) && (e ? e = gb(e, h) : e = h), d = by(a, c, eb(f), d.Ta(this.v[0])), !isFinite(d) || 0 >= d) this.state = 4; else if (this.o = new ey(a, c, f, e, d * (void 0 !== m ? m : .5)), 0 === this.o.c.length) this.state = 4; else if (this.f = b.Dc(d), c = gy(this.o), e && (a.g ? (c[1] = pa(c[1], e[1], e[3]),
      ...
      a = tc(b, c, this.f);
      for (b = a.fa; b <= a.la; b++)for (c = a.ea; c <= a.ka; c++)(m = l(this.f, b, c, g)) && this.a.push(m);
  ...
  hy.prototype.he = function () {
    ...
    this.a.forEach(function (b) {
      b && 2 == b.getState() && a.push({extent: this.c.Ma(b.ya), image: b.Y()})
    }, this);
    this.a.length = 0;
      ...
      this.a.forEach(function (b) {
        ...
        if (0 == c || 1 == c) {
          ...
          var d = y(b, "change", function () {
            var c = b.getState();
            if (2 == c || 3 == c || 4 == c) Gc(d), a--, 0 === a && (this.Id.forEach(Gc), this.Id = null, this.he())
          }, this);
          this.Id.push(d)
        }
      }, this);
  ...
  function Li(a, b, c, d, e) {
    ...
    if (!a)return !1;
    b = !0;
    for (var f, g, h = d.fa; h <= d.la; ++h)for (var l = d.ea; l <= d.ka; ++l)f = c + "/" + h + "/" + l, g = !1, a.a.hasOwnProperty(f) && (f = a.get(f), (g = 2 === f.getState()) && (g = !1 !== e(f))), g || (b = !1);
    return b
  }
  ...
  k.dj = function (a) {
    ...
    if (1 == c) {
      this.V[b] = !0;
      var d = "tileloadstart"
    } else b in this.V && (delete this.V[b], d = 3 == c ? "tileloaderror" : 2 == c || 5 == c ? "tileloadend" : void 0);
  ...
  ry.prototype.La = function (a) {
    if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) ww(this, "error"); else {
      ...
      this.tileUrlFunction = Wx(c.imageUrlSubdomains.map(function (a) {
        ...
        return function (a) {
          if (a)return oc(a[0], a[1], -a[2] - 1, b), a = d, f && (a += "&dpi=d1&device=mobile"), a.replace("{quadkey}", pc(b))
        }
      }));
        ...
        this.va(function (a) {
          ...
          c.imageryProviders.map(function (c) {
            for (var e = !1, f = c.coverageAreas, h = 0, l = f.length; h < l; ++h) {
              var m = f[h];
              if (d >= m.zoomMin && d <= m.zoomMax && (m = m.bbox, m = jb([m[1], m[0], m[3], m[2]], g), hb(m, a.extent))) {
                e = !0;
                break
              }
            }
  ...
  yy.prototype.load = function () {
    if (0 == this.state) {
      ...
      2 == a || 3 == a ? this.he() : (this.je = y(this.Tb, "change", function () {
        var a = this.Tb.getState();
        if (2 == a || 3 == a) Gc(this.je), this.je = null, this.he()
      }, this), this.Tb.load())
    }
  };
  function zy(a) {
  ...
  k.Wc = function (a, b, c) {
    ...
    if (void 0 !== this.O) {
      d = this.O;
      var f = eb(a), g = this.ca, h = cb(a), l = db(a), m = e[0], n = e[1],
        p = .0254 / this.l;
      e = {
  ...
  (function (a) {
    ...
    function c(a) {
      ...
      return function (c) {
        var d = c.buffers, e = c.meta, f = c.width, g = c.height, h = d.length,
          l = d[0].byteLength;
        if (c.imageOps) {
          l = Array(h);
          for (c = 0; c < h; ++c) {
    ...
    function f(a) {
      ...
      var c = [];
      if (b)for (var f = 0; f < b; ++f)c[f] = d(a, this.xh.bind(this, f)); else c[0] = e(a, this.xh.bind(this,
        0));
      this.we = c;
      this.Nd = [];
    ...
    f.prototype.zk = function (a) {
      for (this.Nd.push(a); this.Nd.length > this.Bk;)this.Nd.shift().callback(null, null)
    };
    f.prototype.uh = function () {
      if (0 === this.ve && 0 < this.Nd.length) {
        var a = this.Kf = this.Nd.shift(), b = a.inputs[0].width,
          c = a.inputs[0].height,
          d = a.inputs.map(function (a) {
            return a.data.buffer
          }), e = this.we.length;
        this.ve = e;
        if (1 === e) this.we[0].postMessage({
          buffers: d,
          meta: a.ii,
          imageOps: this.Jf,
          width: b,
  ...
  Sy.prototype.Y = function (a, b, c, d) {
    c = !0;
    for (var e, f = 0, g = this.f.length; f < g; ++f)if (e = this.f[f].a.ha(), "ready" !== e.getState()) {
      c = !1;
      break
    }
    if (!c)return null;
  ...
  Sy.prototype.ca = function (a, b, c, d) {
    if (!b && c) {
      ...
      if (e === this.l.viewState.resolution && Sa(b, this.l.extent)) {
        if (this.a)var f = this.a.Y().getContext("2d"); else f = hg(Math.round(cb(b) / e), Math.round(db(b) / e)), this.a = new ai(b, e, 1, f.canvas);
  ...
  function gz(a) {
    ...
    if (a.url)if (a.jsonp) Zx(a.url, this.Cg.bind(this), this.ef.bind(this)); else {
  ...
  function hz(a) {
    ...
    this.f = void 0;
    this.i = a.jsonp || !1;
    if (a.url)if (this.i) Zx(a.url, this.Dg.bind(this), this.ff.bind(this)); else {
      var b = new XMLHttpRequest;
  ...
  function kz(a) {
    if (0 == a.state)if (a.state = 1, a.o) Zx(a.v, a.bj.bind(a), a.Ne.bind(a)); else {
      var b = new XMLHttpRequest;
  ...
  function Y(a) {
    ...
    this.l = function (a) {
      a =
        "KVP" == c ? Gy(a, e) : a.replace(/\{(\w+?)\}/g, function (a, b) {
  ...
  function vz(a) {
    ...
    var l = new qc({
      tileSize: f,
      extent: b, origin: $a(b), resolutions: d
    });
  ...
  t("ol.loadingstrategy.tile", function (a) {
    return function (b, c) {
      ...
      var d = [];
      c = [c, 0, 0];
      for (c[1] = b.fa; c[1] <= b.la; ++c[1])for (c[2] = b.ea; c[2] <= b.ka; ++c[2])d.push(a.Ma(c));
      return d
    }
  });
  t("ol.Map", K);
  ...
  t("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
    ...
    m = b.requestEncoding;
    m = void 0 !== m ? m : "";
    if ("OperationsMetadata" in a && "GetTile" in a.OperationsMetadata)for (a = a.OperationsMetadata.GetTile.DCP.HTTP.Get, r = 0, p = a.length; r < p; ++r)if (a[r].Constraint) {
      var v = hc(a[r].Constraint, function (a) {
        return "GetEncoding" == a.name
      }).AllowedValues.Value;
      "" === m && (m = v[0]);
      if ("KVP" === m) ec(v, "KVP") && u.push(a[r].href); else break
